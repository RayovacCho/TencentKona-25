...
#define STUBGEN_COMPILER_BLOBS_DO(do_blob, end_blob,                    \
  ...
  do_entry(compiler, ghash_processBlocks, ghash_processBlocks,          \
           ghash_processBlocks)                                         \
  LOONGARCH64_ONLY(do_stub(compiler, descrypt_encryptBlock))            \
  LOONGARCH64_ONLY(do_entry(compiler, descrypt_encryptBlock,            \
                            descrypt_encryptBlock,                      \
                            descrypt_encryptBlock))                     \
  LOONGARCH64_ONLY(do_stub(compiler, descrypt_decryptBlock))            \
  LOONGARCH64_ONLY(do_entry(compiler, descrypt_decryptBlock,            \
